...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 12 juil. 2019 à 13:49
...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `nom_categorie` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `liens` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_liens` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nb_ki_liens` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `personnage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_perso` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `apt_leader_perso` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apt_pass_perso` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_creation_perso` datetime NOT NULL,
  `date_modif_perso` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Structure de la table `personnage_categorie`
--

DROP TABLE IF EXISTS `personnage_categorie`;
CREATE TABLE IF NOT EXISTS `personnage_categorie` (
  `personnage_id` int(11) NOT NULL,
  `categorie_id` int(11) NOT NULL,
  PRIMARY KEY (`personnage_id`,`categorie_id`),
  KEY `IDX_786473F45E315342` (`personnage_id`),
  KEY `IDX_786473F4BCF5E72D` (`categorie_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `personnage_liens`
--

DROP TABLE IF EXISTS `personnage_liens`;
CREATE TABLE IF NOT EXISTS `personnage_liens` (
  `personnage_id` int(11) NOT NULL,
  `liens_id` int(11) NOT NULL,
  PRIMARY KEY (`personnage_id`,`liens_id`),
  KEY `IDX_AF3B6865E315342` (`personnage_id`),
  KEY `IDX_AF3B68662F9273E` (`liens_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Contraintes pour la table `personnage_categorie`
--
ALTER TABLE `personnage_categorie`
  ADD CONSTRAINT `FK_786473F45E315342` FOREIGN KEY (`personnage_id`) REFERENCES `personnage` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_786473F4BCF5E72D` FOREIGN KEY (`categorie_id`) REFERENCES `categorie` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `personnage_liens`
--
ALTER TABLE `personnage_liens`
  ADD CONSTRAINT `FK_AF3B6865E315342` FOREIGN KEY (`personnage_id`) REFERENCES `personnage` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_AF3B68662F9273E` FOREIGN KEY (`liens_id`) REFERENCES `liens` (`id`) ON DELETE CASCADE;
COMMIT;
